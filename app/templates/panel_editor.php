...
<div class="panel">
    <div class="port-grid-wrap">
        <div id="panel-grid" class="port-grid"></div>
    </div>
        ...
        <div class="modal-body">
            ...
            <div class="form-row">
                ...
                <div class="field-group">
                    <label class="field-label" for="m-label">Label</label>
                    <input id="m-label" type="text" class="field-input" maxlength="64" placeholder="e.g. Uplink">
                </div>
            </div>
            <div class="form-row">
                <div class="field-group">
            ...
            <div class="form-row">
                <div class="field-group">
                    <label class="field-label" for="m-device">Device</label>
                    <select id="m-device" class="field-input">
